...
using GenericRepositoryandUoW.Repository;
using GenericRepositoryandUoW.Context;
using System.Data.Entity.Infrastructure;
using System.Data.Entity.Core.Objects;
using System.Data.Entity;
using GenericRepositoryandUoW.Helper;
...
namespace GenericRepositoryandUoW.UnitOfWork
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        public int SaveChanges()
        {
            ...
            if(changeSet != null)
            {
                var user = SessionHelper.GetSessionObject("UserContext") as Model.UserProfileModel;
